...
@Component({
  selector: 'apartment-system-rooms',
  ...
  template: `
    <nb-card [size]="breakpoint.width >= breakpoints.sm ? 'giant' : ''">
      ...
      <apartment-system-room-selector [class.dark-background]="isDarkTheme" (select)="select($event)"></apartment-system-room-selector>
      <apartment-system-player [collapsed]="isCollapsed() && breakpoint.width <= breakpoints.md"></apartment-system-player>
    </nb-card>
  `,
})
